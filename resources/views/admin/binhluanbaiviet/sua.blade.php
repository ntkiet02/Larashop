        ...
        <form action="{{ route('admin.binhluanbaiviet.sua', ['id' => $binhluanbaiviet->id]) }}" method="post">
            ...
            <div class="mb-3">
                ...
                <select class="form-select @error('baiviet_id') is-invalid @enderror" id="baiviet_id" name="baiviet_id"
                    ...
                    <option value="{{ $value->id }}" {{ ($binhluanbaiviet->baiviet_id == $value->id) ? 'selected' : ''
                        }}>{{ $value->tieude }}</option>
                    @endforeach
                </select>
                @error('baiviet_id')
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="noidungbinhluan" name="noidungbinhluan"
                    required>{{ $binhluanbaiviet->noidungbinhluan }}</textarea>
