        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <p>
                        <a href="{{ route('admin.sanpham.them') }}" class="btn btn-info"><i class="bi bi-plus"></i> Thêm
                            mới</a>
                        ...
                        <a href="{{ route('admin.sanpham.xuat') }}" class="btn btn-success"><i
                            ...
                            @foreach($sanpham as $value)
                                <tr>
                                    ...
                                    <td class="text-center"><img
                                            src="{{ env('APP_URL') . '/storage/app/' . $value->hinhanh }}" width="80"
                                    ...
                                    <td class="text-center"><a
                                            href="{{ route('admin.sanpham.sua', ['id' => $value->id]) }}"><i
                                                class="bi bi-pencil-square"></i></a></td>
                                    <td class="text-center"><a
                                            href="{{ route('admin.sanpham.xoa', ['id' => $value->id]) }}"><i
