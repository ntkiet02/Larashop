                    ...
                    <ul class="list-unstyled mb-0">
                        ...
                        <li class="mb-0">
                            <a class="nav-link-style d-flex align-items-center px-4 py-3" href="#">
                                <i class="ci-star opacity-60 me-2"></i>Thiết lập tài khoản<span
                                    class="fs-sm text-muted ms-auto">0</span>
                            </a>
                        </li>
                    </ul>
                ...
                <div class="bg-secondary rounded-3 p-4 mb-4">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ps-3">
                            ...
                            <div class="p mb-0 fs-ms text-muted">Tải lên hình ảnh JPG, GIF hoặc PNG. Yêu cầu kích thước
                                300x300.</div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="password-toggle">
                            <input type="password" class="form-control @error('password') is-invalid @enderror"
                                id="password" name="password" placeholder="Bỏ trống nếu muốn giữ nguyên mật khẩu cũ." />
                    ...
                    <div class="col-12">
                        ...
                        <div class="password-toggle">
                            <input type="password"
                                ...
                                placeholder="Bỏ trống nếu muốn giữ nguyên mật khẩu cũ." />
                            <label class="password-toggle-btn" aria-label="Show/hide password">
                                <input class="password-toggle-check" type="checkbox" />
                                <span class="password-toggle-indicator"></span>
                            </label>
                    ...
                    <div class="col-12">
                        ...
                        <div class="d-flex flex-wrap justify-content-between align-items-center">
                            <div class="form-check">
                                ...
                                <label class="form-check-label" for="subscribe">Đăng ký nhận thông báo từ cửa
                                    hàng.</label>
                            </div>
