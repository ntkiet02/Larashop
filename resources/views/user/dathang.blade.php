        ...
        <section class="col-lg-8">
            ...
            <form id="checkout-form" method="post" action="{{ route('user.dathang') }}">
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control" type="text" id="HoVaTen" value="{{ Auth::user()->name ?? '' }}"
                        disabled />
                </div>
                <div class="mb-3">
            ...
            <div class="d-none d-lg-flex pt-4 mt-3">
                ...
                <div class="w-50 ps-2">
                    <a class="btn btn-primary d-block w-100" href="#checkout"
                ...
                <div class="py-2 px-xl-2">
                        ...
                        <div class="d-flex align-items-center pb-2 border-bottom">
                            ...
                            <div class="ps-2">
                                ...
                                <div class="widget-product-meta">
                                    <span class="text-accent me-2">{{ number_format($value->price, 0, ',', '.')
                                        }}<small>đ</small></span>
                    ...
                    <ul class="list-unstyled fs-sm pb-2 border-bottom">
                        <li class="d-flex justify-content-between align-items-center">
                            <span class="me-2">Tổng tiền sản phẩm:</span><span class="text-end">{{ Cart::priceTotal()
                                }}<small>đ</small></span>
                        </li>
                        <li class="d-flex justify-content-between align-items-center">
