				...
				<div class="card-body">
					...
					<div class="py-3">
						...
						<div class="d-inline-block align-middle">
							<a class="btn-social bs-google me-2 mb-2" href="#" data-bs-toggle="tooltip"
					...
					<form method="post" action="{{ route('login') }}" class="needs-validation" novalidate>
						...
						<div class="alert alert-danger fs-base" role="alert">
							<i class="ci-close-circle me-2"></i>{{ empty($errors->first('email')) ?
						...
						<div class="input-group mb-3">
							...
							<input type="text"
								...
								placeholder="Điện thoại, Email hoặc Tên đăng nhập" required />
						</div>
						...
						<div class="d-flex flex-wrap justify-content-between">
							...
							<a class="nav-link-inline fs-sm" href="{{route('user.dangky')}}">Đăng ký</a>
							@endif
						</div>
						<hr class="mt-4">
						<div class="text-end pt-4">
							<button class="btn btn-primary" type="submit"><i class="ci-sign-in me-2 ms-n21"></i>Đăng
								nhập</button>
						</div>
					</form>
				</div>
