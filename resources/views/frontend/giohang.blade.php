					...
					<div class="pt-2 pt-sm-0 ps-sm-3 mx-auto mx-sm-0 text-center text-sm-start"
						...
						<div class="input-group">
							<span class="input-group-text">
								<a href="{{ route('frontend.giohang.giam', ['row_id' => $value->rowId]) }}"> - </a>
							</span>
							<input class="form-control text-center" type="text" id="qty" name="qty[{{ $value->rowId }}]"
								min="1" value="{{ $value->qty }}" />
							<span class="input-group-text">
								<a href="{{ route('frontend.giohang.tang', ['row_id' => $value->rowId]) }}"> + </a>
							</span>
						</div> 
