        ...
        <div class="col-12">
            <div class="d-flex flex-wrap justify-content-between align-items-center pb-4 mt-n1">
                <div class="d-flex align-items-center fs-sm mb-2">
                    ...
                    <a class="blog-entry-meta-link" href="#date">{{ Carbon\Carbon::createFromFormat('Y-m-d H:i:s',
                        $baiviet->created_at)->format('d/m/Y') }}</a>
                </div>
                <div class="fs-sm mb-2">
                    <a class="blog-entry-meta-link text-nowrap" href="#view" data-scroll><i class="ci-eye"></i>{{
                        $baiviet->luotxem }}</a>
                </div>
            </div>
            ...
            <div class="d-flex flex-wrap justify-content-between pt-2 pb-4 mb-1">
                ...
                <div class="pt-2 mt-5" id="comments">
                    <h2 class="h4">Bình luận<span class="badge bg-secondary fs-sm text-body align-middle ms-2">{{
                            $baiviet->BinhLuanBaiViet->count() }}</span></h2>
                    ...
                    <div class="d-flex align-items-start py-4">
                        ...
                        <div class="ps-3">
                            ...
                            <span class="fs-ms text-muted"><i class="ci-time align-middle me-2"></i>{{
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-start">
                                ...
                                <form class="w-100 needs-validation ms-3" novalidate>
                                    <div class="mb-3">
                                        <textarea class="form-control" rows="3" placeholder="Chia sẻ ý kiến của bạn..."
                                            required></textarea>
                                        @guest
                ...
                <div class="tns-carousel-inner"
                    ...
                    <article>
                        ...
                        <div class="d-flex align-items-center fs-sm mb-2">
                            ...
                            <span class="blog-entry-meta-divider"></span>
                            <a class="blog-entry-meta-link" href="#date">{{ Carbon\Carbon::createFromFormat('Y-m-d
                                H:i:s', $value->created_at)->format('d/m/Y') }}</a>
                        </div>
