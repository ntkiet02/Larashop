...
// Trang cho khách hàng chưa đăng nhập
Route::name('frontend.')->group(function(){
    ...
    // Route::get('/san-pham/{tenhang_slug}/{tenloai_slug}', [HomeController::class, 'sanphamtheonhasanxuat'])->name('sanpham.theonhasanxuat');

    Route::get('/san-pham/{tenhang_slug}', [HomeController::class,'getSanPhamNSX'])-> name('sanpham.phanloaiNSX');
    ...
    Route::get('tim-kiem-san-pham', [HomeController::class, 'search'])->name('sanpham.timkiem');
...
Route::prefix('khach-hang')->name('user.')->middleware(['auth','khachhang'])->group(function() {
// Trang chủ
    ...
    Route::get('/don-hang-chi-tiet/{id}', [KhachHangController::class, 'getSuaDonHangChiTiet'])->name('donhangchitiet');
    Route::post('/don-hang-chi-tiet/{id}', [KhachHangController::class, 'postSuaDonHangChiTiet'])->name('donhangchitiet.sua');

    Route::post('/huy-don-hang/{id}', [KhachHangController::class, 'postHuyDonHang'])->name('huydonhang');
    Route::get('/xoa-don-hang/{id}', [KhachHangController::class, 'getXoa'])->name('xoadonhang');

    Route::get('/don-hang/{id}', [KhachHangController::class, 'getDonHang'])->name('donhang.sua');
    Route::post('/don-hang/{id}', [KhachHangController::class, 'postDonHang'])->name('donhang.sua');
    
    Route::get('/don-hang/{id}', [KhachHangController::class, 'getXoa'])->name('donhang.xoa');
...
Route::prefix('admin')->name('admin.')->middleware(['auth','quanly'])->group(function() {
    // Trang chủ
    ...
    // Quản lý Hãng sản xuất
    Route::get('/banner', [BannersController::class, 'getDanhSach'])->name('banner');
    Route::get('/banner/them', [BannersController::class, 'getThem'])->name('banner.them');
    Route::post('/banner/them', [BannersController::class, 'postThem'])->name('banner.them');
    Route::get('/banner/sua/{id}', [BannersController::class, 'getSua'])->name('banner.sua');
    Route::post('/banner/sua/{id}', [BannersController::class, 'postSua'])->name('banner.sua');
    Route::get('/banner/xoa/{id}', [BannersController::class, 'getXoa'])->name('banner.xoa');
    Route::get('/banner/kichhoat/{id}', [BannersController::class, 'getKichHoat'])->name('banner.kichhoat');
